...
from loan.models import TransactionId # take first 12 characters
...
class EMI(models.Model):
    ...
    """
    transaction_id = models.ForeignKey(TransactionId, on_delete=models.CASCADE, related_name='emi_trans_id', null=True)
